...
def evaluate_prediction_drift(
    ...
    from xgb-churn-model.data.data_ingestion import execute_bq_query
    from xgb-churn-model.monitoring import prediction_drift
    from xgb-churn-model.monitoring.inference_history_table import (
        fetch_historical_inference,
    )
    from xgb-churn-model.monitoring.metrics import (
        write_metrics_to_cloud_monitoring,
    )
    from xgb-churn-model.monitoring.metrics import write_metrics_to_table
